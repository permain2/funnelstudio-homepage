...
Download `homepage-public.tgz` and `manifest.json` from the [v1.1.3 release](https://github.com/permain2/funnelstudio-homepage/releases/tag/v1.1.3). This is a separate production-root package; do not deploy the GitHub Pages `docs/` build at your domain root.
...
3. Copy only the versioned `gal/fsw-v1.1.3/` assets into the homepage web root. Verify their public URLs before switching the index.
